...
import { ReactComponent as CircleImg } from 'app/assets/icons/circle.svg';
...
const LayoutComponent:FC<LayoutComponentProps>= ({device,layout}) => {
        ...
        <div className="containerDeviceLayout"
            ...
            <div className="propertiesDeviceLayout">
                <span className="nameDeviceLayout">
                    <div className="iconDeviceLayout">{device?.online ? <CircleImg style={{fill: '#5ABEA6'}}/> : <CircleImg style={{fill: 'red'}}/>}</div>
