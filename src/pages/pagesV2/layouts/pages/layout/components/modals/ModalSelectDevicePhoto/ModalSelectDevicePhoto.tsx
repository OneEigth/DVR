...
import {PhotoRecordArray} from "../../../../../../../../api/fotoRec/photoRecArray/PhotoRecArray";
...
const ModalSelectDevicePhoto: React.FC<ModalSelectDeviceProps> = ({ visible, onOk, onCancel, layoutViewType }) => {
    ...
    const handleStartRecordingPhoto = async () => {
        ...
        try {
            ...
            const response = await PhotoRecordArray(SmartDVRToken, userLogin, { UID: selectedDevices });
            if (response) {
        ...
        <>
            ...
            >
                ...
                <div style={{ display: "flex", gap: "10px", marginTop: "10px" }}>
                    <Button
                        type="primary"
                        onClick={handleStartRecordingPhoto}
                        loading={loading}
...
export default ModalSelectDevicePhoto;