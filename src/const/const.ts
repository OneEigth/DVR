...
//GET_PLAY_FILE
export const FILE_PLAY_URL = (uid: string) => `http://45.141.76.30:8172/play/file/${uid}/ac425fec-0856-11ef-8012-0001693eb0e4`;

/*export const FILE_PLAY_URL = (uid: string, headers: Record<string, string>) => {
    const headerParams = new URLSearchParams(headers).toString();
    return `http://45.141.76.30:8172/play/file/${uid}?${headerParams}`;
};*/
export const FILE_PLAY_HEADERS = {
    SmartDVRLogin: 'admin',
    SmartDVRToken: 'ac425fec-0856-11ef-8012-0001693eb0e4',
};
